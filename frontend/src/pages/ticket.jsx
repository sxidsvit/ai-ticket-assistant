...
export default function TicketDetailsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      <h2 className="text-2xl font-bold mb-4 text-gray-200">Ticket Details</h2>

      <div className="card bg-gray-800 shadow p-4 space-y-4">
        <h3 className="text-xl font-semibold text-gray-200">{ticket.title}</h3>
        <p className="text-sm text-gray-300 mb-2">{ticket.description}</p>

        {/* Conditionally render extended details */}
        {ticket.status && (
          <>
            <div className="divider text-gray-200">Metadata</div>
